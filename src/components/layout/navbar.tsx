                                ...
                                <AnimatePresence>
                                    {showUserMenu && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-[#e9e0f5] overflow-hidden py-2"
                                        >
                                            <div className="px-4 py-2 border-b border-[#f3ebff] mb-1">
                                                <p className="text-xs text-[#606266] uppercase tracking-wider font-semibold">Signed in as</p>
                                                <p className="text-sm font-medium text-[#101011] truncate">{user.email}</p>
                                            </div>
                                            <a 
                                                href={`${DASHBOARD_URL}/dashboard`}
                                                className="flex items-center gap-3 px-4 py-2.5 text-sm text-[#606266] hover:bg-[#FAF5FF] hover:text-[#71389A] transition-colors"
                                            >
                            ...
                            {!user ? (
                                ...
                                <>
                                    <a
                                        ...
                                        className="flex items-center justify-center gap-2 h-10 rounded-full border-2 border-[#71389A] text-[#71389A] font-medium"
                                    >
                                        <LayoutDashboard size={16} />
                                        Dashboard
                                    </a>
