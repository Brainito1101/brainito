                                ...
                                <div key={item.id} className="relative md:min-h-[300px] flex flex-col md:block">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-center">
                                        ...
                                        <div className="md:order-2 md:pl-16 order-2">
                                            ...
                                            >
                                                <h3 className="text-xl md:text-2xl font-semibold text-[#A359D9] mb-2">{item.yearTitle}</h3>
                                                <h4 className="text-md font-normal text-[#101011] mb-2">{item.subtitle}</h4>
                                                <p className="text-[#606266] text-sm leading-relaxed max-w-[450px] mb-16">
                                                    {item.description}
                                                </p>
                                            </motion.div>
                                        </div>
                                        ...
                                        <div className="md:order-1 md:pr-16 order-1">
                                            {item.id === 1 && (
                                                <div className="hidden md:block absolute -left-20 top-0 w-[500px]">
                                                    <motion.div
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-center">
                                        ...
                                        <div className="md:order-1 md:text-right md:pr-16 order-2">
                                            ...
                                            >
                                                <h3 className="text-xl md:text-2xl font-semibold text-[#A359D9] mb-2">{item.yearTitle}</h3>
                                                <h4 className="text-md font-normal text-[#101011] mb-2">{item.subtitle}</h4>
                                                <p className="text-[#606266] text-sm leading-relaxed max-w-[450px] md:ml-auto mb-16">
                                                    {item.description}
                                                </p>
                                            </motion.div>
                                        </div>
                                        ...
                                        <div className="md:order-2 md:pl-16 order-1">
                                            {item.id === 5 && (
                                                <div className="hidden md:block absolute -right-20 top-0 w-[500px]">
                                                    <motion.div
                                                        initial={{ opacity: 0, x: 50 }}
                                                        whileInView={{ opacity: 1, x: 0 }}
                                                        viewport={{ once: true }}
